...
public class Main {
    ...
    private static void readObjectsFromFile() {
        try {
            ...
            Tiger savedTiger = (Tiger) tigerIn.readObject();
            tigerIn.close();
            System.out.println("Tiger details from file:");
            System.out.println(savedTiger);
           

            // Read Penguin
            ObjectInputStream penguinIn = new ObjectInputStream(new FileInputStream("penguin.txt"));
            Penguin savedPenguin = (Penguin) penguinIn.readObject();
            penguinIn.close();
            System.out.println("Penguin details from file:");
            System.out.println(savedPenguin);
         
            // Read Dolphin
            ObjectInputStream dolphinIn = new ObjectInputStream(new FileInputStream("dolphin.txt"));
            Dolphin savedDolphin = (Dolphin) dolphinIn.readObject();
            dolphinIn.close();
            System.out.println("Dolphin details from file:");
           System.out.println(savedDolphin);
